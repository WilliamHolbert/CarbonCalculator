...
ggplot(WaterDischarge, aes(x=year))+
  geom_point(aes(y=MWhElectric), color="blue")+
  geom_line(aes(y=MWhElectric), color="blue",linetype="dashed")+
  facet_wrap(~waterTypeType, scales='free')+
